...
slat-bench.js — 11 variant(s) swept in 679ms · 11 built · 9 passed · 2 excluded by --require passed · 9 ranked by max:slatPitch
...
**worst** verdict it found: `0` clean · `1` built with problems · `2` did not build · `3`
could not run. That is a CI gate, so there is a GitHub Action for it — a thin wrapper around
...
[`docs/`](docs/) holds the 17 sections of the skill pack the hosted platform teaches
...
Generated from the Axle Keys repository — 18 source files, derived by walking the
engine's own imports; 6 examples; 17 docs sections; 4 skills. The picture at the
