...
its min and max, and each pair at opposite ends). The lesson of this file: curved forms come from **revolved profiles** and **lofts through
...
**Specific to this one:** look before adding the next feature — a self-intersecting spline
builds clean and returns a green verdict, and reads wrong only to an eye.
